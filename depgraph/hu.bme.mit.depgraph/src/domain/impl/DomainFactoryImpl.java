...
public class DomainFactoryImpl extends EFactoryImpl implements DomainFactory {
	...
	public static DomainFactory init() {
		try {
			DomainFactory theDomainFactory = (DomainFactory)EPackage.Registry.INSTANCE.getEFactory("http://dependency-graph/1.0"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case DomainPackage.PRODUCT: return createProduct();
			case DomainPackage.API_CLASS: return createApiClass();
			case DomainPackage.METHOD: return createMethod();
			case DomainPackage.FIELD: return createField();
			case DomainPackage.DEPENDENCY: return createDependency();
			case DomainPackage.DEPENDENCY_GRAPH: return createDependencyGraph();
			case DomainPackage.TRANSITIVE_DEPENDENCY: return createTransitiveDependency();
			default:
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case DomainPackage.DEPENDENCY_TYPE:
	 ...
	 * @generated
	 */
	public TransitiveDependency createTransitiveDependency() {
		TransitiveDependencyImpl transitiveDependency = new TransitiveDependencyImpl();
