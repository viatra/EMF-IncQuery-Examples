...
/**
 * Pattern-specific match representation of the studentName pattern, 
 * to be used in conjunction with StudentNameMatcher.
 * 
 ...
 * 
 */
public final class StudentNameMatch extends BasePatternMatch implements IPatternMatch {
  private Object fS;
  ...
  public StudentNameMatch(final Object pS, final Object pName) {
    this.fS = pS;
    this.fName = pName;
  ...
  public String[] parameterNames() {
    return StudentNameMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    ...
    if (!pattern().equals(otherSig.pattern()))
    	return false;
    if (!StudentNameMatch.class.equals(obj.getClass()))
    	return Arrays.deepEquals(toArray(), otherSig.toArray());
    				StudentNameMatch other = (StudentNameMatch) obj;
  ...
  public Pattern pattern() {
    return StudentNameMatcher.FACTORY.getPattern();
  }
}
