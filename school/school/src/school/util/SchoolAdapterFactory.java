...
public class SchoolAdapterFactory extends AdapterFactoryImpl {
	...
	protected SchoolSwitch<Adapter> modelSwitch =
		new SchoolSwitch<Adapter>() {
            ...
            @Override
            public Adapter caseSpecialisationCourse(SpecialisationCourse object) {
                return createSpecialisationCourseAdapter();
            }
            @Override
            ...
            @Override
            public Adapter caseLimitedCapacityCourse(LimitedCapacityCourse object) {
                return createLimitedCapacityCourseAdapter();
            }
            @Override
	...
	/**
     * Creates a new adapter for an object of class '{@link school.SchoolClass <em>Class</em>}'.
     * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
     * Creates a new adapter for an object of class '{@link school.SpecialisationCourse <em>Specialisation Course</em>}'.
     * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
     * Creates a new adapter for an object of class '{@link school.Year <em>Year</em>}'.
     * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
     * Creates a new adapter for an object of class '{@link school.LimitedCapacityCourse <em>Limited Capacity Course</em>}'.
     * <!-- begin-user-doc -->
     * This default implementation returns null so that we can easily ignore cases;
     * it's useful to ignore a case when inheritance will catch all the cases anyway.
     * <!-- end-user-doc -->
     ...
     * @generated
     */
    public Adapter createLimitedCapacityCourseAdapter() {
        return null;
    }
