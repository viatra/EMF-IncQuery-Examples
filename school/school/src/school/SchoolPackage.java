 ...
 * <!-- end-user-doc -->
 * <!-- begin-model-doc -->
 * The School package corresponds to the EMF-IncQuery example found at [http://incquery.net/incquery/new/examples/school].
 * <!-- end-model-doc -->
...
public interface SchoolPackage extends EPackage {
	...
	/**
	 * The meta object id for the '{@link school.impl.LimitedCapacityCourseImpl <em>Limited Capacity Course</em>}' class.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 * @see school.impl.LimitedCapacityCourseImpl
	 * @see school.impl.SchoolPackageImpl#getLimitedCapacityCourse()
	 * @generated
	 */
    int LIMITED_CAPACITY_COURSE = 7;
	 ...
	 * @ordered
	 */
    int LIMITED_CAPACITY_COURSE__SUBJECT = COURSE__SUBJECT;
	 ...
	 * @ordered
	 */
    int LIMITED_CAPACITY_COURSE__WEIGHT = COURSE__WEIGHT;
	 ...
	 * @ordered
	 */
    int LIMITED_CAPACITY_COURSE__SCHOOL = COURSE__SCHOOL;
	 ...
	 * @ordered
	 */
    int LIMITED_CAPACITY_COURSE__TEACHER = COURSE__TEACHER;
	 ...
	 * @ordered
	 */
    int LIMITED_CAPACITY_COURSE__SCHOOL_CLASS = COURSE__SCHOOL_CLASS;
	 ...
	 * @ordered
	 */
    int LIMITED_CAPACITY_COURSE__CAPACITY = COURSE_FEATURE_COUNT + 0;

    /**
	 * The number of structural features of the '<em>Limited Capacity Course</em>' class.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
    int LIMITED_CAPACITY_COURSE_FEATURE_COUNT = COURSE_FEATURE_COUNT + 1;
	...
	/**
	 * Returns the meta object for class '{@link school.LimitedCapacityCourse <em>Limited Capacity Course</em>}'.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Limited Capacity Course</em>'.
	 * @see school.LimitedCapacityCourse
	 * @generated
	 */
    EClass getLimitedCapacityCourse();

    /**
	 * Returns the meta object for the attribute '{@link school.LimitedCapacityCourse#getCapacity <em>Capacity</em>}'.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Capacity</em>'.
	 * @see school.LimitedCapacityCourse#getCapacity()
	 * @see #getLimitedCapacityCourse()
	 * @generated
	 */
    EAttribute getLimitedCapacityCourse_Capacity();
	...
	interface Literals {
        ...
        /**
		 * The meta object literal for the '{@link school.impl.LimitedCapacityCourseImpl <em>Limited Capacity Course</em>}' class.
		 * <!-- begin-user-doc -->
         * <!-- end-user-doc -->
		 * @see school.impl.LimitedCapacityCourseImpl
		 * @see school.impl.SchoolPackageImpl#getLimitedCapacityCourse()
		 * @generated
		 */
        EClass LIMITED_CAPACITY_COURSE = eINSTANCE.getLimitedCapacityCourse();
		 ...
		 * @generated
		 */
        EAttribute LIMITED_CAPACITY_COURSE__CAPACITY = eINSTANCE.getLimitedCapacityCourse_Capacity();
