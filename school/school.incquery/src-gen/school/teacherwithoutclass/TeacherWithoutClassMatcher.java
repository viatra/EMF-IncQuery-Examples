...
public class TeacherWithoutClassMatcher extends BaseGeneratedMatcher<TeacherWithoutClassMatch> implements IncQueryMatcher<TeacherWithoutClassMatch> {
  ...
  public TeacherWithoutClassMatch newMatch(final Teacher pT) {
    return new TeacherWithoutClassMatch(pT);
  ...
  @Override
  public TeacherWithoutClassMatch tupleToMatch(final Tuple t) {
    try {
    	return new TeacherWithoutClassMatch((school.Teacher) t.get(POSITION_T));	
  ...
  @Override
  public TeacherWithoutClassMatch arrayToMatch(final Object[] match) {
    try {
    	return new TeacherWithoutClassMatch((school.Teacher) match[POSITION_T]);
