...
public abstract class SchoolsMatch extends BasePatternMatch {
  ...
  @Override
  public SchoolsMatch toImmutable() {
    return isMutable() ? newMatch(fSch) : this;
  }
   ...
   * 
   */
  public static SchoolsMatch newEmptyMatch() {
   ...
   * 
   */
  public static SchoolsMatch newMutableMatch(final School pSch) {
    return new Mutable(pSch);
  }
   ...
   * 
   */
  public static SchoolsMatch newMatch(final School pSch) {
    return new Immutable(pSch);
  }
  
  private static final class Mutable extends SchoolsMatch {
  ...
  private static final class Immutable extends SchoolsMatch {
