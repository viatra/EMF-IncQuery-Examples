...
/**
 * Pattern-specific match representation of the school.B_translated pattern,
 * to be used in conjunction with {@link B_translatedMatcher}.
 * 
...
public abstract class B_translatedMatch extends BasePatternMatch {
  ...
  private B_translatedMatch(final SchoolClass pSelf, final Student pStudent2, final Student pStudent1, final String pName) {
    this.fSelf = pSelf;
  ...
  public List<String> parameterNames() {
    return B_translatedMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof B_translatedMatch)) { // this should be infrequent
    	if (obj == null)
    		return false;
    ...
    B_translatedMatch other = (B_translatedMatch) obj;
  ...
  @Override
  public B_translatedQuerySpecification specification() {
    try {
  ...
  @SuppressWarnings("all")
  static final class Mutable extends B_translatedMatch {
  ...
  @SuppressWarnings("all")
  static final class Immutable extends B_translatedMatch {
