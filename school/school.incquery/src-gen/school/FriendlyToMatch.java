...
public abstract class FriendlyToMatch extends BasePatternMatch {
  ...
  @Override
  public FriendlyToMatch toImmutable() {
  ...
  @Override
  public FriendlyToQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static FriendlyToMatch newEmptyMatch() {
   ...
   * 
   */
  public static FriendlyToMatch newMutableMatch(final Student pS1, final Student pS2) {
   ...
   * 
   */
  public static FriendlyToMatch newMatch(final Student pS1, final Student pS2) {
    return new Immutable(pS1, pS2);
  }
  
  private static final class Mutable extends FriendlyToMatch {
  ...
  private static final class Immutable extends FriendlyToMatch {
