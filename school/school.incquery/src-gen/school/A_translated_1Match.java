...
/**
 * Pattern-specific match representation of the school.A_translated_1 pattern,
 * to be used in conjunction with {@link A_translated_1Matcher}.
 * 
...
public abstract class A_translated_1Match extends BasePatternMatch {
  private Student fS2;
  ...
  private A_translated_1Match(final Student pS2, final Student pS1) {
    this.fS2 = pS2;
    this.fS1 = pS1;
  ...
  public List<String> parameterNames() {
    return A_translated_1Match.parameterNames;
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof A_translated_1Match)) { // this should be infrequent
    	if (obj == null)
    		return false;
    ...
    A_translated_1Match other = (A_translated_1Match) obj;
  ...
  @Override
  public A_translated_1QuerySpecification specification() {
    try {
  ...
  @SuppressWarnings("all")
  static final class Mutable extends A_translated_1Match {
  ...
  @SuppressWarnings("all")
  static final class Immutable extends A_translated_1Match {
