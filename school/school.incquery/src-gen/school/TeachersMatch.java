...
public abstract class TeachersMatch extends BasePatternMatch {
  ...
  @Override
  public TeachersMatch toImmutable() {
  ...
  @Override
  public TeachersQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static TeachersMatch newEmptyMatch() {
   ...
   * 
   */
  public static TeachersMatch newMutableMatch(final Teacher pT) {
   ...
   * 
   */
  public static TeachersMatch newMatch(final Teacher pT) {
    return new Immutable(pT);
  }
  
  private static final class Mutable extends TeachersMatch {
  ...
  private static final class Immutable extends TeachersMatch {
