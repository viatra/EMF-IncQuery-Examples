...
public class AnonymousVariablesMatcher extends BaseMatcher<AnonymousVariablesMatch> {
   ...
   */
  @Deprecated
  public DeltaMonitor<AnonymousVariablesMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final Teacher pTeacher) {
    return rawNewFilteredDeltaMonitor(fillAtStart, new Object[]{pTeacher});
  }
  ...
  public AnonymousVariablesMatch newMatch(final Teacher pTeacher) {
    return new AnonymousVariablesMatch.Immutable(pTeacher);
  ...
  protected AnonymousVariablesMatch tupleToMatch(final Tuple t) {
    try {
      return new AnonymousVariablesMatch.Immutable((school.Teacher) t.get(POSITION_TEACHER));
  ...
  protected AnonymousVariablesMatch arrayToMatch(final Object[] match) {
    try {
      return new AnonymousVariablesMatch.Immutable((school.Teacher) match[POSITION_TEACHER]);
    } catch(ClassCastException e) {
  ...
  protected AnonymousVariablesMatch arrayToMatchMutable(final Object[] match) {
    try {
      return new AnonymousVariablesMatch.Mutable((school.Teacher) match[POSITION_TEACHER]);
    } catch(ClassCastException e) {
      LOGGER.error("Element(s) in array not properly typed!",e);
      return null;
    }
