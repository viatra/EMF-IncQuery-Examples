...
public abstract class FinalPatternMatch extends BasePatternMatch {
  ...
  @Override
  public FinalPatternMatch toImmutable() {
    return isMutable() ? newMatch(fY, fC, fT, fS) : this;
  }
   ...
   * 
   */
  public static FinalPatternMatch newEmptyMatch() {
   ...
   * 
   */
  public static FinalPatternMatch newMutableMatch(final Year pY, final Course pC, final Teacher pT, final Student pS) {
    return new Mutable(pY, pC, pT, pS);
  }
   ...
   * 
   */
  public static FinalPatternMatch newMatch(final Year pY, final Course pC, final Teacher pT, final Student pS) {
    return new Immutable(pY, pC, pT, pS);
  }
  
  private static final class Mutable extends FinalPatternMatch {
  ...
  private static final class Immutable extends FinalPatternMatch {
