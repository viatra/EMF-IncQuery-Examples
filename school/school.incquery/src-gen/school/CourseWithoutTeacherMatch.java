...
public abstract class CourseWithoutTeacherMatch extends BasePatternMatch {
  ...
  @Override
  public CourseWithoutTeacherMatch toImmutable() {
  ...
  @Override
  public CourseWithoutTeacherQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static CourseWithoutTeacherMatch newEmptyMatch() {
   ...
   * 
   */
  public static CourseWithoutTeacherMatch newMutableMatch(final Course pC) {
   ...
   * 
   */
  public static CourseWithoutTeacherMatch newMatch(final Course pC) {
    return new Immutable(pC);
  }
  
  private static final class Mutable extends CourseWithoutTeacherMatch {
  ...
  private static final class Immutable extends CourseWithoutTeacherMatch {
