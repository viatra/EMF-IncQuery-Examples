 ...
 * to be used in conjunction with {@link CourseWithWeightThirtyMatcher}.
 * 
...
public abstract class CourseWithWeightThirtyMatch extends BasePatternMatch {
  ...
  private CourseWithWeightThirtyMatch(final Course pC) {
    this.fC = pC;
  }
  ...
  @Override
  public CourseWithWeightThirtyMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof CourseWithWeightThirtyMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
  ...
  @Override
  public CourseWithWeightThirtyQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static CourseWithWeightThirtyMatch newEmptyMatch() {
   ...
   * 
   */
  public static CourseWithWeightThirtyMatch newMutableMatch(final Course pC) {
   ...
   * 
   */
  public static CourseWithWeightThirtyMatch newMatch(final Course pC) {
    return new Immutable(pC);
  }
  
  private static final class Mutable extends CourseWithWeightThirtyMatch {
  ...
  private static final class Immutable extends CourseWithWeightThirtyMatch {
