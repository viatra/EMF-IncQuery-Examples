...
public abstract class CourseWithTeacherMatch extends BasePatternMatch {
  ...
  @Override
  public CourseWithTeacherMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof CourseWithTeacherMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
  ...
  @Override
  public CourseWithTeacherQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static CourseWithTeacherMatch newEmptyMatch() {
   ...
   * 
   */
  public static CourseWithTeacherMatch newMutableMatch(final Course pC) {
   ...
   * 
   */
  public static CourseWithTeacherMatch newMatch(final Course pC) {
    return new Immutable(pC);
  }
  
  private static final class Mutable extends CourseWithTeacherMatch {
  ...
  private static final class Immutable extends CourseWithTeacherMatch {
