...
public class TeachersOfSchoolMatcher extends BaseGeneratedMatcher<TeachersOfSchoolMatch> implements IncQueryMatcher<TeachersOfSchoolMatch> {
  ...
  public TeachersOfSchoolMatch tupleToMatch(final Tuple t) {
    try {
    	return new TeachersOfSchoolMatch((school.Teacher) t.get(POSITION_T), (school.School) t.get(POSITION_SCH));	
  ...
  public TeachersOfSchoolMatch arrayToMatch(final Object[] match) {
    try {
    	return new TeachersOfSchoolMatch((school.Teacher) match[POSITION_T], (school.School) match[POSITION_SCH]);
