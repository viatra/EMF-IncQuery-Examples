...
public final class AlphabeticallyAfterFriendQuerySpecification extends BaseGeneratedQuerySpecification<AlphabeticallyAfterFriendMatcher> {
  ...
  @SuppressWarnings("all")
  public static class Provider implements IQuerySpecificationProvider<AlphabeticallyAfterFriendQuerySpecification> {
    @Override
    public AlphabeticallyAfterFriendQuerySpecification get() throws IncQueryException {
      return instance();
    }
  }
