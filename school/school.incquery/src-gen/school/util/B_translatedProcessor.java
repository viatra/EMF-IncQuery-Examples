...
/**
 * A match processor tailored for the school.B_translated pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class B_translatedProcessor implements IMatchProcessor<B_translatedMatch> {
  /**
  ...
  @Override
  public void process(final B_translatedMatch match) {
