...
/**
 * A match processor tailored for the school.A_translated_0 pattern.
 * 
 * Clients should derive an (anonymous) class that implements the abstract process().
 * 
 */
@SuppressWarnings("all")
public abstract class A_translated_0Processor implements IMatchProcessor<A_translated_0Match> {
  /**
  ...
  @Override
  public void process(final A_translated_0Match match) {
