...
/**
 * Pattern-specific match representation of the school.increasingAlphabeticalFriendshipChainTC pattern,
 * to be used in conjunction with {@link IncreasingAlphabeticalFriendshipChainTCMatcher}.
 * 
...
public abstract class IncreasingAlphabeticalFriendshipChainTCMatch extends BasePatternMatch {
  private Student fS1;
  ...
  private IncreasingAlphabeticalFriendshipChainTCMatch(final Student pS1, final Student pS2) {
    this.fS1 = pS1;
    this.fS2 = pS2;
  }
  ...
  public List<String> parameterNames() {
    return IncreasingAlphabeticalFriendshipChainTCMatch.parameterNames;
  }
  ...
  @Override
  public IncreasingAlphabeticalFriendshipChainTCMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof IncreasingAlphabeticalFriendshipChainTCMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
    ...
    IncreasingAlphabeticalFriendshipChainTCMatch other = (IncreasingAlphabeticalFriendshipChainTCMatch) obj;
  ...
  @Override
  public IncreasingAlphabeticalFriendshipChainTCQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static IncreasingAlphabeticalFriendshipChainTCMatch newEmptyMatch() {
   ...
   * 
   */
  public static IncreasingAlphabeticalFriendshipChainTCMatch newMutableMatch(final Student pS1, final Student pS2) {
   ...
   * 
   */
  public static IncreasingAlphabeticalFriendshipChainTCMatch newMatch(final Student pS1, final Student pS2) {
    return new Immutable(pS1, pS2);
  }
  
  private static final class Mutable extends IncreasingAlphabeticalFriendshipChainTCMatch {
  ...
  private static final class Immutable extends IncreasingAlphabeticalFriendshipChainTCMatch {
