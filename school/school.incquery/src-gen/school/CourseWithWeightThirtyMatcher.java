...
public class CourseWithWeightThirtyMatcher extends BaseMatcher<CourseWithWeightThirtyMatch> {
  ...
  public CourseWithWeightThirtyMatch newMatch(final Course pC) {
    return CourseWithWeightThirtyMatch.newMatch(pC);
  }
  ...
  protected CourseWithWeightThirtyMatch tupleToMatch(final Tuple t) {
    try {
    	return CourseWithWeightThirtyMatch.newMatch((school.Course) t.get(POSITION_C));
  ...
  protected CourseWithWeightThirtyMatch arrayToMatch(final Object[] match) {
    try {
    	return CourseWithWeightThirtyMatch.newMatch((school.Course) match[POSITION_C]);
    } catch(ClassCastException e) {
  ...
  protected CourseWithWeightThirtyMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return CourseWithWeightThirtyMatch.newMutableMatch((school.Course) match[POSITION_C]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
