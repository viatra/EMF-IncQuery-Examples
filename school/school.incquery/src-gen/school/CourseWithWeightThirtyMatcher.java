...
public class CourseWithWeightThirtyMatcher extends BaseMatcher<CourseWithWeightThirtyMatch> {
  ...
  public static CourseWithWeightThirtyMatcher on(final IncQueryEngine engine) throws IncQueryException {
    ...
    CourseWithWeightThirtyMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(CourseWithWeightThirtyMatcher.class);
