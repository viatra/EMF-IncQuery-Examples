...
public class AllVariablesNamedMatcher extends BaseMatcher<AllVariablesNamedMatch> {
   ...
   */
  @Deprecated
  public DeltaMonitor<AllVariablesNamedMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final Teacher pTeacher) {
  ...
  public AllVariablesNamedMatch newMatch(final Teacher pTeacher) {
    return new AllVariablesNamedMatch.Immutable(pTeacher);
  ...
  protected AllVariablesNamedMatch tupleToMatch(final Tuple t) {
    try {
      return new AllVariablesNamedMatch.Immutable((school.Teacher) t.get(POSITION_TEACHER));
  ...
  protected AllVariablesNamedMatch arrayToMatch(final Object[] match) {
    try {
      return new AllVariablesNamedMatch.Immutable((school.Teacher) match[POSITION_TEACHER]);
    } catch(ClassCastException e) {
  ...
  protected AllVariablesNamedMatch arrayToMatchMutable(final Object[] match) {
    try {
      return new AllVariablesNamedMatch.Mutable((school.Teacher) match[POSITION_TEACHER]);
    } catch(ClassCastException e) {
      LOGGER.error("Element(s) in array not properly typed!",e);
      return null;
    }
