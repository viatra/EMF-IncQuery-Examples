...
public class TeachersNamesMatcher extends BaseMatcher<TeachersNamesMatch> {
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(TeachersNamesMatcher.class);
  ...
  public TeachersNamesMatch newMatch(final String pTN) {
    return TeachersNamesMatch.newMatch(pTN);
  }
  ...
  protected TeachersNamesMatch tupleToMatch(final Tuple t) {
    try {
    	return TeachersNamesMatch.newMatch((java.lang.String) t.get(POSITION_TN));
  ...
  protected TeachersNamesMatch arrayToMatch(final Object[] match) {
    try {
    	return TeachersNamesMatch.newMatch((java.lang.String) match[POSITION_TN]);
    } catch(ClassCastException e) {
  ...
  protected TeachersNamesMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return TeachersNamesMatch.newMutableMatch((java.lang.String) match[POSITION_TN]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
