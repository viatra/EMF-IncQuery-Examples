...
public class FinalPatternMatcher extends BaseMatcher<FinalPatternMatch> {
  ...
  public FinalPatternMatch newMatch(final Year pY, final Course pC, final Teacher pT, final Student pS) {
    return FinalPatternMatch.newMatch(pY, pC, pT, pS);
  }
  ...
  public Set<Year> getAllValuesOfY(final Course pC, final Teacher pT, final Student pS) {
    return rawAccumulateAllValuesOfY(new Object[]{
    null, 
    pC, 
    pT, 
    pS
  ...
  protected FinalPatternMatch tupleToMatch(final Tuple t) {
    try {
    	return FinalPatternMatch.newMatch((school.Year) t.get(POSITION_Y), (school.Course) t.get(POSITION_C), (school.Teacher) t.get(POSITION_T), (school.Student) t.get(POSITION_S));
  ...
  protected FinalPatternMatch arrayToMatch(final Object[] match) {
    try {
    	return FinalPatternMatch.newMatch((school.Year) match[POSITION_Y], (school.Course) match[POSITION_C], (school.Teacher) match[POSITION_T], (school.Student) match[POSITION_S]);
    } catch(ClassCastException e) {
  ...
  protected FinalPatternMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return FinalPatternMatch.newMutableMatch((school.Year) match[POSITION_Y], (school.Course) match[POSITION_C], (school.Teacher) match[POSITION_T], (school.Student) match[POSITION_S]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
