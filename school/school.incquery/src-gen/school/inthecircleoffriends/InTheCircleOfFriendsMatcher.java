 ...
 * 
 */
public class InTheCircleOfFriendsMatcher extends BaseGeneratedMatcher<InTheCircleOfFriendsMatch> implements IncQueryMatcher<InTheCircleOfFriendsMatch> {
  ...
  public Set<Student> getAllValuesOfS1(final Student pSomeone) {
    Student pS1 = null;
    return rawAccumulateAllValuesOfS1(new Object[]{pS1, pSomeone});
  }
   ...
   * 
   */
  public Set<Student> rawAccumulateAllValuesOfSomeone(final Object[] parameters) {
    Set<Student> results = new HashSet<Student>();
  ...
  public Set<Student> getAllValuesOfSomeone(final Student pS1) {
    Student pSomeone = null;
    return rawAccumulateAllValuesOfSomeone(new Object[]{pS1, pSomeone});
  }
  
  @Override
  public InTheCircleOfFriendsMatch tupleToMatch(final Tuple t) {
    try {
    	return new InTheCircleOfFriendsMatch((school.Student) t.get(POSITION_S1), (school.Student) t.get(POSITION_SOMEONE));	
  ...
  public InTheCircleOfFriendsMatch arrayToMatch(final Object[] match) {
    try {
    	return new InTheCircleOfFriendsMatch((school.Student) match[POSITION_S1], (school.Student) match[POSITION_SOMEONE]);
