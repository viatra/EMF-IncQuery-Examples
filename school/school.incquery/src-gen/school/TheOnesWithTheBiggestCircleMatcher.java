...
public class TheOnesWithTheBiggestCircleMatcher extends BaseMatcher<TheOnesWithTheBiggestCircleMatch> {
  /**
  ...
  public static TheOnesWithTheBiggestCircleMatcher on(final IncQueryEngine engine) throws IncQueryException {
    ...
    TheOnesWithTheBiggestCircleMatcher matcher = engine.getExistingMatcher(querySpecification());
    if (matcher == null) {
  ...
  private final static Logger LOGGER = IncQueryLoggingUtil.getLogger(TheOnesWithTheBiggestCircleMatcher.class);
   ...
   */
  @Deprecated
  public TheOnesWithTheBiggestCircleMatcher(final Notifier emfRoot) throws IncQueryException {
   ...
   */
  @Deprecated
  public TheOnesWithTheBiggestCircleMatcher(final IncQueryEngine engine) throws IncQueryException {
  ...
  public TheOnesWithTheBiggestCircleMatch newMatch(final Student pS) {
    return TheOnesWithTheBiggestCircleMatch.newMatch(pS);
  }
  ...
  protected TheOnesWithTheBiggestCircleMatch tupleToMatch(final Tuple t) {
    try {
    	return TheOnesWithTheBiggestCircleMatch.newMatch((school.Student) t.get(POSITION_S));
  ...
  @Override
  protected TheOnesWithTheBiggestCircleMatch arrayToMatch(final Object[] match) {
    try {
    	return TheOnesWithTheBiggestCircleMatch.newMatch((school.Student) match[POSITION_S]);
    } catch(ClassCastException e) {
  ...
  @Override
  protected TheOnesWithTheBiggestCircleMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return TheOnesWithTheBiggestCircleMatch.newMutableMatch((school.Student) match[POSITION_S]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
   ...
   * 
   */
  public static IQuerySpecification<TheOnesWithTheBiggestCircleMatcher> querySpecification() throws IncQueryException {
