...
public class ClassesOfTeacherNamesMatcher extends BaseMatcher<ClassesOfTeacherNamesMatch> {
  ...
  public ClassesOfTeacherNamesMatch newMatch(final String pTName, final Character pSCName) {
    return ClassesOfTeacherNamesMatch.newMatch(pTName, pSCName);
  }
  ...
  public Set<Character> getAllValuesOfSCName(final String pTName) {
    return rawAccumulateAllValuesOfSCName(new Object[]{
    pTName, 
    null
    });
  }
  ...
  protected ClassesOfTeacherNamesMatch tupleToMatch(final Tuple t) {
    try {
    	return ClassesOfTeacherNamesMatch.newMatch((java.lang.String) t.get(POSITION_TNAME), (java.lang.Character) t.get(POSITION_SCNAME));
  ...
  protected ClassesOfTeacherNamesMatch arrayToMatch(final Object[] match) {
    try {
    	return ClassesOfTeacherNamesMatch.newMatch((java.lang.String) match[POSITION_TNAME], (java.lang.Character) match[POSITION_SCNAME]);
    } catch(ClassCastException e) {
  ...
  protected ClassesOfTeacherNamesMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return ClassesOfTeacherNamesMatch.newMutableMatch((java.lang.String) match[POSITION_TNAME], (java.lang.Character) match[POSITION_SCNAME]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
