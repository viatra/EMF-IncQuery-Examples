...
public class FinalPattern2Matcher extends BaseMatcher<FinalPattern2Match> {
  ...
  public FinalPattern2Match newMatch(final Integer pYDate, final String pCSub, final String pTName, final String pSName) {
    return FinalPattern2Match.newMatch(pYDate, pCSub, pTName, pSName);
  }
  ...
  public Set<Integer> getAllValuesOfYDate(final String pCSub, final String pTName, final String pSName) {
    return rawAccumulateAllValuesOfYDate(new Object[]{
    null, 
    pCSub, 
    pTName, 
    pSName
  ...
  public Set<String> getAllValuesOfCSub(final Integer pYDate, final String pTName, final String pSName) {
    return rawAccumulateAllValuesOfCSub(new Object[]{
    pYDate, 
    null, 
    pTName, 
    pSName
  ...
  protected FinalPattern2Match tupleToMatch(final Tuple t) {
    try {
    	return FinalPattern2Match.newMatch((java.lang.Integer) t.get(POSITION_YDATE), (java.lang.String) t.get(POSITION_CSUB), (java.lang.String) t.get(POSITION_TNAME), (java.lang.String) t.get(POSITION_SNAME));
  ...
  protected FinalPattern2Match arrayToMatch(final Object[] match) {
    try {
    	return FinalPattern2Match.newMatch((java.lang.Integer) match[POSITION_YDATE], (java.lang.String) match[POSITION_CSUB], (java.lang.String) match[POSITION_TNAME], (java.lang.String) match[POSITION_SNAME]);
    } catch(ClassCastException e) {
  ...
  protected FinalPattern2Match arrayToMatchMutable(final Object[] match) {
    try {
    	return FinalPattern2Match.newMutableMatch((java.lang.Integer) match[POSITION_YDATE], (java.lang.String) match[POSITION_CSUB], (java.lang.String) match[POSITION_TNAME], (java.lang.String) match[POSITION_SNAME]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
