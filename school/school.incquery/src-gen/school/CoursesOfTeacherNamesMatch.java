...
public abstract class CoursesOfTeacherNamesMatch extends BasePatternMatch {
  ...
  @Override
  public CoursesOfTeacherNamesMatch toImmutable() {
    return isMutable() ? newMatch(fTName, fCName) : this;
  }
   ...
   * 
   */
  public static CoursesOfTeacherNamesMatch newEmptyMatch() {
   ...
   * 
   */
  public static CoursesOfTeacherNamesMatch newMutableMatch(final String pTName, final String pCName) {
    return new Mutable(pTName, pCName);
  }
   ...
   * 
   */
  public static CoursesOfTeacherNamesMatch newMatch(final String pTName, final String pCName) {
    return new Immutable(pTName, pCName);
  }
  
  private static final class Mutable extends CoursesOfTeacherNamesMatch {
  ...
  private static final class Immutable extends CoursesOfTeacherNamesMatch {
