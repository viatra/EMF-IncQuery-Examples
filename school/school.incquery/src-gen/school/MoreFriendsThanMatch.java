...
public abstract class MoreFriendsThanMatch extends BasePatternMatch {
  ...
  @Override
  public MoreFriendsThanMatch toImmutable() {
   ...
   * 
   */
  public static MoreFriendsThanMatch newEmptyMatch() {
   ...
   * 
   */
  public static MoreFriendsThanMatch newMutableMatch(final Student pS1, final Student pS2) {
   ...
   * 
   */
  public static MoreFriendsThanMatch newMatch(final Student pS1, final Student pS2) {
    return new Immutable(pS1, pS2);
  }
  
  private static final class Mutable extends MoreFriendsThanMatch {
  ...
  private static final class Immutable extends MoreFriendsThanMatch {
