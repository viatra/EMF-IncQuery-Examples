...
public abstract class TeacherWithoutClassMatch extends BasePatternMatch {
  ...
  @Override
  public TeacherWithoutClassMatch toImmutable() {
  ...
  public boolean equals(final Object obj) {
    if (this == obj)
    	return true;
    if (!(obj instanceof TeacherWithoutClassMatch)) { // this should be infrequent
    	if (obj == null) {
    		return false;
    	}
  ...
  @Override
  public TeacherWithoutClassQuerySpecification specification() {
    try {
   ...
   * 
   */
  public static TeacherWithoutClassMatch newEmptyMatch() {
   ...
   * 
   */
  public static TeacherWithoutClassMatch newMutableMatch(final Teacher pT) {
   ...
   * 
   */
  public static TeacherWithoutClassMatch newMatch(final Teacher pT) {
    return new Immutable(pT);
  }
  
  private static final class Mutable extends TeacherWithoutClassMatch {
  ...
  private static final class Immutable extends TeacherWithoutClassMatch {
