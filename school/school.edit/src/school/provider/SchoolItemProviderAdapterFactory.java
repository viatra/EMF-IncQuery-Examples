...
public class SchoolItemProviderAdapterFactory extends SchoolAdapterFactory implements ComposeableAdapterFactory, IChangeNotifier, IDisposable {
	...
	/**
	 * This keeps track of the one adapter used for all {@link school.LimitedCapacityCourse} instances.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 * @generated
	 */
    protected LimitedCapacityCourseItemProvider limitedCapacityCourseItemProvider;

    /**
	 * This creates an adapter for a {@link school.LimitedCapacityCourse}.
	 * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
	 * @generated
	 */
    ...
    public Adapter createLimitedCapacityCourseAdapter() {
		if (limitedCapacityCourseItemProvider == null) {
			limitedCapacityCourseItemProvider = new LimitedCapacityCourseItemProvider(this);
		}

		return limitedCapacityCourseItemProvider;
	}
	...
	public void dispose() {
		...
		if (limitedCapacityCourseItemProvider != null) limitedCapacityCourseItemProvider.dispose();
	}
