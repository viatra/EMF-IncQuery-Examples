...
public class SchoolNameMatcher extends BaseGeneratedMatcher<SchoolNameMatch> implements IncQueryMatcher<SchoolNameMatch> {
   ...
   * 
   */
  public Collection<SchoolNameMatch> getAllMatches(final Object pS, final String pName) {
   ...
   * 
   */
  public SchoolNameMatch getOneArbitraryMatch(final Object pS, final String pName) {
   ...
   * 
   */
  public void forEachMatch(final Object pS, final String pName, final IMatchProcessor<? super SchoolNameMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Object pS, final String pName, final IMatchProcessor<? super SchoolNameMatch> processor) {
   ...
   * 
   */
  public DeltaMonitor<SchoolNameMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final Object pS, final String pName) {
  ...
  public SchoolNameMatch tupleToMatch(final Tuple t) {
    try {
    	return new SchoolNameMatch((java.lang.Object) t.get(0), (java.lang.String) t.get(1));	
  ...
  public SchoolNameMatch arrayToMatch(final Object[] match) {
    try {
    	return new SchoolNameMatch((java.lang.Object) match[0], (java.lang.String) match[1]);
