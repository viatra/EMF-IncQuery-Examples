...
/**
 * Pattern-specific match representation of the sameCodeClassDifferentYearsBetter pattern, 
 * to be used in conjunction with SameCodeClassDifferentYearsBetterMatcher.
 * 
 ...
 * 
 */
public final class SameCodeClassDifferentYearsBetterMatch extends BasePatternMatch implements IPatternMatch {
  ...
  public SameCodeClassDifferentYearsBetterMatch(final Object pElderStudent, final Object pYoungerStudent) {
  ...
  public String patternName() {
    return "sameCodeClassDifferentYearsBetter";
    
  }
  
  @Override
  public String[] parameterNames() {
    return SameCodeClassDifferentYearsBetterMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    ...
    if (!pattern().equals(otherSig.pattern()))
    	return false;
    if (!SameCodeClassDifferentYearsBetterMatch.class.equals(obj.getClass()))
    	return Arrays.deepEquals(toArray(), otherSig.toArray());
    				SameCodeClassDifferentYearsBetterMatch other = (SameCodeClassDifferentYearsBetterMatch) obj;
  ...
  public Pattern pattern() {
    return SameCodeClassDifferentYearsBetterMatcher.FACTORY.getPattern();
  }
}
