...
/**
 * Pattern-specific match representation of the inSameSchoolDifferentYears pattern, 
 * to be used in conjunction with InSameSchoolDifferentYearsMatcher.
 * 
 ...
 * 
 */
public final class InSameSchoolDifferentYearsMatch extends BasePatternMatch implements IPatternMatch {
  ...
  public InSameSchoolDifferentYearsMatch(final Object pElderStudent, final Object pYoungerStudent) {
  ...
  public String patternName() {
    return "inSameSchoolDifferentYears";
    
  }
  
  @Override
  public String[] parameterNames() {
    return InSameSchoolDifferentYearsMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    ...
    if (!pattern().equals(otherSig.pattern()))
    	return false;
    if (!InSameSchoolDifferentYearsMatch.class.equals(obj.getClass()))
    	return Arrays.deepEquals(toArray(), otherSig.toArray());
    				InSameSchoolDifferentYearsMatch other = (InSameSchoolDifferentYearsMatch) obj;
  ...
  public Pattern pattern() {
    return InSameSchoolDifferentYearsMatcher.FACTORY.getPattern();
  }
}
