...
public class StudentNameMatcher extends BaseGeneratedMatcher<StudentNameMatch> implements IncQueryMatcher<StudentNameMatch> {
   ...
   * 
   */
  public Collection<StudentNameMatch> getAllMatches(final Object pS, final String pName) {
   ...
   * 
   */
  public StudentNameMatch getOneArbitraryMatch(final Object pS, final String pName) {
   ...
   * 
   */
  public boolean hasMatch(final Object pS, final String pName) {
   ...
   * 
   */
  public int countMatches(final Object pS, final String pName) {
   ...
   * 
   */
  public void forEachMatch(final Object pS, final String pName, final IMatchProcessor<? super StudentNameMatch> processor) {
   ...
   * 
   */
  public boolean forOneArbitraryMatch(final Object pS, final String pName, final IMatchProcessor<? super StudentNameMatch> processor) {
   ...
   * 
   */
  public DeltaMonitor<StudentNameMatch> newFilteredDeltaMonitor(final boolean fillAtStart, final Object pS, final String pName) {
  ...
  public StudentNameMatch tupleToMatch(final Tuple t) {
    try {
    	return new StudentNameMatch((java.lang.Object) t.get(0), (java.lang.String) t.get(1));	
  ...
  public StudentNameMatch arrayToMatch(final Object[] match) {
    try {
    	return new StudentNameMatch((java.lang.Object) match[0], (java.lang.String) match[1]);
