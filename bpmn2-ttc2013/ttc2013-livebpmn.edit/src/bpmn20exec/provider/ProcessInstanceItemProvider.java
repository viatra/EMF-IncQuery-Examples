...
/**
 * This is the item provider adapter for a {@link bpmn20exec.ProcessInstance} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessInstanceItemProvider
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 getResourceLocator(),
                 getString("_UI_ProcessInstance_process_feature"),
                 getString("_UI_PropertyDescriptor_description", "_UI_ProcessInstance_process_feature", "_UI_ProcessInstance_type"),
                 Bpmn20execPackage.Literals.PROCESS_INSTANCE__PROCESS,
                 true,
                 false,
                 true,
                 null,
        ...
        itemPropertyDescriptors.add
            (createItemPropertyDescriptor
                (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
                 ...
                 Bpmn20execPackage.Literals.PROCESS_INSTANCE__STATE,
                 true,
                 false,
                 false,
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(Bpmn20execPackage.Literals.PROCESS_INSTANCE__TOKENS);
        }
    ...
    public String getText(Object object) {
        ProcessState labelValue = ((ProcessInstance)object).getState();
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (Bpmn20execPackage.Literals.PROCESS_INSTANCE__TOKENS,
                 Bpmn20execFactory.eINSTANCE.createToken()));
    }
    ...
    public ResourceLocator getResourceLocator() {
        return Bpmn20execEditPlugin.INSTANCE;
    }
