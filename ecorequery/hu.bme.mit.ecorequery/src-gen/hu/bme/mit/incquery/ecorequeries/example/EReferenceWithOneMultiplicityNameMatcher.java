...
public class EReferenceWithOneMultiplicityNameMatcher extends BaseMatcher<EReferenceWithOneMultiplicityNameMatch> {
   ...
   * 
   */
  public static EReferenceWithOneMultiplicityNameMatcher on(final ViatraQueryEngine engine) throws IncQueryException {
   ...
   */
  @Deprecated
  public EReferenceWithOneMultiplicityNameMatcher(final ViatraQueryEngine engine) throws IncQueryException {
  ...
  protected EReferenceWithOneMultiplicityNameMatch tupleToMatch(final Tuple t) {
    try {
    	return EReferenceWithOneMultiplicityNameMatch.newMatch((String) t.get(POSITION_EREFNAME));
  ...
  protected EReferenceWithOneMultiplicityNameMatch arrayToMatch(final Object[] match) {
    try {
    	return EReferenceWithOneMultiplicityNameMatch.newMatch((String) match[POSITION_EREFNAME]);
    } catch(ClassCastException e) {
  ...
  protected EReferenceWithOneMultiplicityNameMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return EReferenceWithOneMultiplicityNameMatch.newMutableMatch((String) match[POSITION_EREFNAME]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
