 ...
 * 
 */
public class EReferenceWithStarMultiplicityMatcher extends BaseGeneratedMatcher<EReferenceWithStarMultiplicityMatch> {
  /**
  ...
  public static EReferenceWithStarMultiplicityMatcher on(final IncQueryEngine engine) throws IncQueryException {
    ...
    if (matcher == null) {
    	matcher = new EReferenceWithStarMultiplicityMatcher(engine);
