...
public class EReferenceWithStarMultiplicityNameMatcher extends BaseMatcher<EReferenceWithStarMultiplicityNameMatch> {
   ...
   * 
   */
  public static EReferenceWithStarMultiplicityNameMatcher on(final ViatraQueryEngine engine) throws IncQueryException {
   ...
   */
  @Deprecated
  public EReferenceWithStarMultiplicityNameMatcher(final ViatraQueryEngine engine) throws IncQueryException {
  ...
  protected EReferenceWithStarMultiplicityNameMatch tupleToMatch(final Tuple t) {
    try {
    	return EReferenceWithStarMultiplicityNameMatch.newMatch((String) t.get(POSITION_EREFNAME));
  ...
  protected EReferenceWithStarMultiplicityNameMatch arrayToMatch(final Object[] match) {
    try {
    	return EReferenceWithStarMultiplicityNameMatch.newMatch((String) match[POSITION_EREFNAME]);
    } catch(ClassCastException e) {
  ...
  protected EReferenceWithStarMultiplicityNameMatch arrayToMatchMutable(final Object[] match) {
    try {
    	return EReferenceWithStarMultiplicityNameMatch.newMutableMatch((String) match[POSITION_EREFNAME]);
    } catch(ClassCastException e) {
    	LOGGER.error("Element(s) in array not properly typed!",e);
    	return null;
    }
