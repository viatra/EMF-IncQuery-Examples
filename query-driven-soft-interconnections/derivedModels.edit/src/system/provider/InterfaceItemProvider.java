...
/**
 * This is the item provider adapter for a {@link system.Interface} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Interface_user_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Interface_user_feature", "_UI_Interface_type"),
				 SystemPackage.Literals.INTERFACE__USER,
				 true,
				 false,
				 true,
				 null,
