...
/**
 * This is the item provider adapter for a {@link process.Activity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Activity_next_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Activity_next_feature", "_UI_Activity_type"),
				 ProcessPackage.Literals.ACTIVITY__NEXT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addPreviousPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Activity_previous_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Activity_previous_feature", "_UI_Activity_type"),
				 ProcessPackage.Literals.ACTIVITY__PREVIOUS,
				 true,
				 false,
				 true,
				 null,
