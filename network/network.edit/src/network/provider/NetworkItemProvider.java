...
public class NetworkItemProvider
    ...
    public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
        if (childrenFeatures == null) {
            ...
            childrenFeatures.add(NetworkPackage.Literals.NETWORK__PEOPLE);
            childrenFeatures.add(NetworkPackage.Literals.NETWORK__POSTS);
        }
    ...
    protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
        ...
        newChildDescriptors.add
            (createChildParameter
                (NetworkPackage.Literals.NETWORK__PEOPLE,
                 NetworkFactory.eINSTANCE.createPerson()));

        newChildDescriptors.add
            (createChildParameter
                (NetworkPackage.Literals.NETWORK__POSTS,
                 NetworkFactory.eINSTANCE.createPost()));
    }
