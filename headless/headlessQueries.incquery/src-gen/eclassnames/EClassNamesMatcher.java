...
/**
 * Generated pattern matcher API of the EClassNames pattern, 
 ...
 * @see EClassNamesMatcherFactory
 * @see EClassNamesProcessor
 * 
 */
public class EClassNamesMatcher extends BaseGeneratedMatcher<EClassNamesMatch> implements IncQueryMatcher<EClassNamesMatch> {
  /**
   ...
   * 
   */
  public EClassNamesMatcher(final Notifier notifier) throws IncQueryRuntimeException {
   ...
   * 
   */
  public EClassNamesMatcher(final IncQueryEngine engine) throws IncQueryRuntimeException {
  ...
  @Override
  public EClassNamesMatch tupleToMatch(final Tuple t) {
    try {
    	return new EClassNamesMatch((org.eclipse.emf.ecore.EClass) t.get(0), (java.lang.String) t.get(1));	
    } catch(ClassCastException e) {System.err.println("Error when executing tupleToMatch in EClassNamesMatcher:" + e.getMessage());
  ...
  @Override
  public EClassNamesMatch arrayToMatch(final Object[] match) {
    try {
    	return new EClassNamesMatch((org.eclipse.emf.ecore.EClass) match[0], (java.lang.String) match[1]);
    } catch(ClassCastException e) {System.err.println("Error when executing arrayToMatch in EClassNamesMatcher:" + e.getMessage());
    }
    		//throw new IncQueryRuntimeException(e.getMessage());
    		return null;
  ...
  public final static IMatcherFactory<EClassNamesMatch,EClassNamesMatcher> FACTORY =  new EClassNamesMatcherFactory();
}
