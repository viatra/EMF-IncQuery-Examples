 ...
 *   <li>{@link school.Year#getWeightOfRegularCourses <em>Weight Of Regular Courses</em>}</li>
 * </ul>
 * </p>
 *
...
public interface Year extends EObject {
  ...
  /**
   * Returns the value of the '<em><b>Weight Of Regular Courses</b></em>' attribute.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Weight Of Regular Courses</em>' attribute isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Weight Of Regular Courses</em>' attribute.
   * @see school.SchoolPackage#getYear_WeightOfRegularCourses()
   * @model transient="true" changeable="false" volatile="true" derived="true"
   * @generated
   */
  int getWeightOfRegularCourses();
