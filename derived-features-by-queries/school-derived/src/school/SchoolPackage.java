...
public interface SchoolPackage extends EPackage {
   ...
   * @generated
   */
	String eNS_URI = "http:///school-derived.ecore";
   ...
   */
	...
	/**
   * The feature id for the '<em><b>Number Of Teachers</b></em>' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
	int SCHOOL__NUMBER_OF_TEACHERS = 5;

	/**
   * The feature id for the '<em><b>Teachers With Most Courses</b></em>' reference list.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
	int SCHOOL__TEACHERS_WITH_MOST_COURSES = 6;

	/**
   * The feature id for the '<em><b>Last Year</b></em>' reference.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
	int SCHOOL__LAST_YEAR = 7;

	/**
   * The feature id for the '<em><b>Current Year</b></em>' attribute.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
	int SCHOOL__CURRENT_YEAR = 8;

	/**
   * The feature id for the '<em><b>Min Weight In Last Year</b></em>' reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int SCHOOL__MIN_WEIGHT_IN_LAST_YEAR = 9;
   ...
   * @ordered
   */
	int SCHOOL_CLASS__HOMEROOM_TEACHER = 3;
   ...
   * @ordered
   */
	int SCHOOL_CLASS__CODE = 4;

  /**
   * The feature id for the '<em><b>Homeroom Courses</b></em>' reference list.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int SCHOOL_CLASS__HOMEROOM_COURSES = 5;
   ...
   * @ordered
   */
	int SCHOOL_CLASS_FEATURE_COUNT = 6;
   ...
   */
	...
	/**
   * The feature id for the '<em><b>Weight Of Regular Courses</b></em>' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   * @ordered
   */
  int YEAR__WEIGHT_OF_REGULAR_COURSES = 3;
   ...
   */
	...
	/**
   * Returns the meta object for the attribute '{@link school.School#getNumberOfTeachers <em>Number Of Teachers</em>}'.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Number Of Teachers</em>'.
   * @see school.School#getNumberOfTeachers()
   * @see #getSchool()
   * @generated
   */
	EAttribute getSchool_NumberOfTeachers();

	/**
   * Returns the meta object for the reference list '{@link school.School#getTeachersWithMostCourses <em>Teachers With Most Courses</em>}'.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   * @return the meta object for the reference list '<em>Teachers With Most Courses</em>'.
   * @see school.School#getTeachersWithMostCourses()
   * @see #getSchool()
   * @generated
   */
	EReference getSchool_TeachersWithMostCourses();

	/**
   * Returns the meta object for the reference '{@link school.School#getLastYear <em>Last Year</em>}'.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   * @return the meta object for the reference '<em>Last Year</em>'.
   * @see school.School#getLastYear()
   * @see #getSchool()
   * @generated
   */
	EReference getSchool_LastYear();

	/**
   * Returns the meta object for the attribute '{@link school.School#getCurrentYear <em>Current Year</em>}'.
   * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Current Year</em>'.
   * @see school.School#getCurrentYear()
   * @see #getSchool()
   * @generated
   */
	EAttribute getSchool_CurrentYear();

	/**
   * Returns the meta object for the reference '{@link school.School#getMinWeightInLastYear <em>Min Weight In Last Year</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the reference '<em>Min Weight In Last Year</em>'.
   * @see school.School#getMinWeightInLastYear()
   * @see #getSchool()
   * @generated
   */
  EReference getSchool_MinWeightInLastYear();
   ...
   */
	...
	/**
   * Returns the meta object for the reference list '{@link school.SchoolClass#getHomeroomCourses <em>Homeroom Courses</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the reference list '<em>Homeroom Courses</em>'.
   * @see school.SchoolClass#getHomeroomCourses()
   * @see #getSchoolClass()
   * @generated
   */
  EReference getSchoolClass_HomeroomCourses();
   ...
   */
	...
	/**
   * Returns the meta object for the attribute '{@link school.Year#getWeightOfRegularCourses <em>Weight Of Regular Courses</em>}'.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @return the meta object for the attribute '<em>Weight Of Regular Courses</em>'.
   * @see school.Year#getWeightOfRegularCourses()
   * @see #getYear()
   * @generated
   */
  EAttribute getYear_WeightOfRegularCourses();
   ...
   */
     ...
     */
		...
		/**
     * The meta object literal for the '<em><b>Number Of Teachers</b></em>' attribute feature.
     * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
     * @generated
     */
		EAttribute SCHOOL__NUMBER_OF_TEACHERS = eINSTANCE.getSchool_NumberOfTeachers();

		/**
     * The meta object literal for the '<em><b>Teachers With Most Courses</b></em>' reference list feature.
     * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
     * @generated
     */
		EReference SCHOOL__TEACHERS_WITH_MOST_COURSES = eINSTANCE.getSchool_TeachersWithMostCourses();

		/**
     * The meta object literal for the '<em><b>Last Year</b></em>' reference feature.
     * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
     * @generated
     */
		EReference SCHOOL__LAST_YEAR = eINSTANCE.getSchool_LastYear();

		/**
     * The meta object literal for the '<em><b>Current Year</b></em>' attribute feature.
     * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
     * @generated
     */
		EAttribute SCHOOL__CURRENT_YEAR = eINSTANCE.getSchool_CurrentYear();

		/**
     * The meta object literal for the '<em><b>Min Weight In Last Year</b></em>' reference feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EReference SCHOOL__MIN_WEIGHT_IN_LAST_YEAR = eINSTANCE.getSchool_MinWeightInLastYear();
     ...
     */
		...
		/**
     * The meta object literal for the '<em><b>Homeroom Courses</b></em>' reference list feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EReference SCHOOL_CLASS__HOMEROOM_COURSES = eINSTANCE.getSchoolClass_HomeroomCourses();
    ...
    /**
     * The meta object literal for the '<em><b>Weight Of Regular Courses</b></em>' attribute feature.
     * <!-- begin-user-doc -->
     * <!-- end-user-doc -->
     * @generated
     */
    EAttribute YEAR__WEIGHT_OF_REGULAR_COURSES = eINSTANCE.getYear_WeightOfRegularCourses();
