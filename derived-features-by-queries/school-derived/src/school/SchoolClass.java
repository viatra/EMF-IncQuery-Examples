 ...
 *   <li>{@link school.SchoolClass#getHomeroomCourses <em>Homeroom Courses</em>}</li>
 * </ul>
 * </p>
 *
...
public interface SchoolClass extends EObject {
   ...
   */
	...
	/**
   * Returns the value of the '<em><b>Homeroom Courses</b></em>' reference list.
   * The list contents are of type {@link school.Course}.
   * <!-- begin-user-doc -->
   * <p>
   * If the meaning of the '<em>Homeroom Courses</em>' reference list isn't clear,
   * there really should be more of a description here...
   * </p>
   * <!-- end-user-doc -->
   * @return the value of the '<em>Homeroom Courses</em>' reference list.
   * @see school.SchoolPackage#getSchoolClass_HomeroomCourses()
   * @model transient="true" changeable="false" volatile="true" derived="true"
   * @generated
   */
  EList<Course> getHomeroomCourses();
