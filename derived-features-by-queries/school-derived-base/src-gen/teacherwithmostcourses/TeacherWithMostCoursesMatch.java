...
/**
 * Pattern-specific match representation of the teacherWithMostCourses pattern, 
 * to be used in conjunction with TeacherWithMostCoursesMatcher.
 * 
 ...
 * 
 */
public final class TeacherWithMostCoursesMatch extends BasePatternMatch implements IPatternMatch {
  ...
  public TeacherWithMostCoursesMatch(final Object pSchool, final Object pTeacher) {
  ...
  public String[] parameterNames() {
    return TeacherWithMostCoursesMatch.parameterNames;
  ...
  public boolean equals(final Object obj) {
    ...
    if (!pattern().equals(otherSig.pattern()))
    	return false;
    if (!TeacherWithMostCoursesMatch.class.equals(obj.getClass()))
    	return Arrays.deepEquals(toArray(), otherSig.toArray());
    				TeacherWithMostCoursesMatch other = (TeacherWithMostCoursesMatch) obj;
  ...
  public Pattern pattern() {
    return TeacherWithMostCoursesMatcher.FACTORY.getPattern();
  }
}
