...
public class SchoolClassItemProvider
   ...
   */
    ...
    if (itemPropertyDescriptors == null) {
      ...
      addHomeroomCoursesPropertyDescriptor(object);
    }
   ...
   */
	...
	/**
   * This adds a property descriptor for the Homeroom Courses feature.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   * @generated
   */
  protected void addHomeroomCoursesPropertyDescriptor(Object object) {
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         getResourceLocator(),
         getString("_UI_SchoolClass_homeroomCourses_feature"),
         getString("_UI_PropertyDescriptor_description", "_UI_SchoolClass_homeroomCourses_feature", "_UI_SchoolClass_type"),
         SchoolPackage.Literals.SCHOOL_CLASS__HOMEROOM_COURSES,
         false,
         false,
         false,
         null,
